...
public class SearchTC extends Commondetails {
	...
	public void Startpage() throws IOException {
		...
		// SearchPage.getSearchPage().DateSelection(exceldata.getstringdata("Sheet1", 3, 1), exceldata.getstringdata("Sheet1", 4, 1));
		SearchPage.getSearchPage().DateSelection(Months, Date);
		//logger.info("User is to select Return Date of Travel ");
		SearchPage.getSearchPage().ReturnDateselection(exceldata.getstringdata("Sheet1", 5, 1), exceldata.getstringdata("Sheet1", 6, 1));
